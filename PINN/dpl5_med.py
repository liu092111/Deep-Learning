...
layer_size=[2]+[64]*5+[1] #first XXXX is the width of neural, second XX is layer of hidden layer 
activation='tanh'
...
losshistory, train_state=model.train(iterations=50000) #suggest range 1000~50000
