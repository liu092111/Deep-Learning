...
# 訓練函數
def train_model(model, train_set_r, train_set_u, val_set_r, val_set_u, n_epoch=10000, lr=1e-4):
    ...
    for epoch in range(1, n_epoch + 1):
        ...
        if val_loss < best_loss:
            best_loss = val_loss.item()  # 使用 .item() 來獲取浮點數
...
print("\nObservations:")
print("1. Wider Model: ", end="")
print("Increased model capacity, potentially allowing for better feature extraction.")
print("2. Deeper Model: ", end="")
print("Increased depth allows for more complex function approximation, but may be harder to train.")
print("3. ReLU Model: ", end="")
print("ReLU activation can help with vanishing gradient problem, but may lead to 'dying ReLU' issue.")
print("\nPlease refer to the bar plot for a visual comparison of the models' performance.")